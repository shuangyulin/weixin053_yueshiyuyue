...
public class YonghuyuyueController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,YonghuyuyueEntity yonghuyuyue, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			yonghuyuyue.setYonghuming((String)request.getSession().getAttribute("username"));
		}
