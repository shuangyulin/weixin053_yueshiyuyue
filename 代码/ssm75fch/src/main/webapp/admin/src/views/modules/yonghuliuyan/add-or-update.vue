      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="留言标题" prop="liuyanbiaoti">
          <el-input v-model="ruleForm.liuyanbiaoti" 
              placeholder="留言标题" clearable  :readonly="ro.liuyanbiaoti"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yonghuliuyan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yonghuliuyanCrossAddOrUpdateFlag = false;
                  this.parent.search();
